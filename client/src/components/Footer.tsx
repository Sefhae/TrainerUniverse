        ...
        <div className="grid gap-12 md:grid-cols-[1.6fr_1fr_1fr]">
          ...
          <div>
            ...
            <ul className="mt-5 space-y-3 text-sm">
              <li>
                <Link to="/" className="text-bone/70 transition-colors duration-200 hover:text-volt">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/trainers" className="text-bone/70 transition-colors duration-200 hover:text-volt">
                  Find a Trainer
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-5 space-y-3 text-sm">
              <li>
                <Link to="/register" className="text-bone/70 transition-colors duration-200 hover:text-volt">
                  Become a Trainer
                </Link>
              </li>
              <li>
                <Link to="/login" className="text-bone/70 transition-colors duration-200 hover:text-volt">
                  Trainer Login
                </Link>
              </li>
            </ul>
