    ...
    <div className="min-h-screen bg-surface text-content">
      <div className="border-b border-content/10">
        <div className="mx-auto max-w-7xl px-5 py-12 lg:px-8 lg:py-16">
          ...
          <p className="mt-4 max-w-xl text-sm leading-relaxed text-content/55">{t.trainers.desc}</p>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-5 py-10 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-[280px_1fr]">
          <aside className="hidden lg:block">
            <div className="no-scrollbar sticky top-20 max-h-[calc(100vh-6rem)] overflow-y-auto border border-content/10">
              <FilterSidebar
                filters={filters}
      ...
      {drawerOpen && (
        <div className="animate-fade-in fixed inset-0 z-[140] flex flex-col bg-surface lg:hidden">
