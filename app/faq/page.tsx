  ...
  return (
    <div className="border-b border-white/10 last:border-b-0">
      ...
      >
        ...
        <ChevronDown
          className={cn(
            'mt-0.5 h-5 w-5 shrink-0 text-bone/40 transition-transform duration-300',
            open && 'rotate-180 text-volt'
          )}
        />
      </button>
      <div
      ...
      >
        <p className="text-sm leading-relaxed text-bone/60">{a}</p>
      </div>
    </div>
  );
}
...
function FaqSection({
  ...
  return (
    ...
    >
      <h2 className="mb-1 font-display text-3xl tracking-wide text-bone sm:text-4xl">{title}</h2>
      <div className="mt-5 border border-white/10 bg-charcoal px-6">
        {items.map((item) => (
    ...
    <div className="min-h-screen bg-ink text-bone">
      ...
      <div className="border-b border-white/10">
        <div className="mx-auto max-w-7xl px-5 py-16 lg:px-8 lg:py-20">
          ...
          <p className="mt-5 max-w-xl text-base leading-relaxed text-bone/55">{t.faq.desc}</p>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-5 py-16 lg:px-8 lg:py-20">
        ...
        <div className="mt-20 grid gap-4 border border-volt/20 bg-volt/5 p-8 sm:grid-cols-2 sm:items-center sm:gap-8 lg:p-10">
          <div>
            ...
            <h3 className="mt-2 font-display text-3xl tracking-wide text-bone sm:text-4xl">
              {t.nav.findTrainer}
            </h3>
          </div>
