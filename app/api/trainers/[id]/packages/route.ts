...
import { mapPackage } from '../../../../../src/lib/serialize';
...
export async function POST(req: NextRequest, { params }: Params) {
  ...
  const created = db.prepare('SELECT * FROM pricing_packages WHERE id = ?').get(info.lastInsertRowid) as Record<string, unknown>;
